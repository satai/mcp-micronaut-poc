        ...
        `when`("using Client with Std in out communication to list tools") {
            ...
            then("should be able to call all variants of MultiTypeToolKotlin tools") {
                ...
                table(
                    ...
                    row("singleParamTool_array_of_longs_java", "param1", JsonArray(listOf(JsonPrimitive(3), JsonPrimitive(2))), "MultiTypeToolJava_ArrayOfLongs answer [3, 2]"),
                    row("singleParamTool_array_of_doubles_java", "param1", JsonArray(listOf(JsonPrimitive(3.12), JsonPrimitive(2))), "MultiTypeToolJava_ArrayOfDoubles answer [3.12, 2.0]"),
                    row("singleParamTool_array_of_floats_java", "param1", JsonArray(listOf(JsonPrimitive(3.01), JsonPrimitive(2))), "MultiTypeToolJava_ArrayOfFloats answer [3.01, 2.0]"),
